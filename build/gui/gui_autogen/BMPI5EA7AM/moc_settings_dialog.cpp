...
#include <memory>
#include "../../../../shared/gui_ws/src/gui/include/gui/settings_dialog.hpp"
...
QT_MOC_LITERAL(15, 15), // "settingsApplied"
QT_MOC_LITERAL(31, 0), // ""
QT_MOC_LITERAL(32, 16), // "robotTypeChanged"
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->robotTypeChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsDialog::settingsApplied)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsDialog::robotTypeChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SettingsDialog::robotTypeChanged(int _t1)
{
