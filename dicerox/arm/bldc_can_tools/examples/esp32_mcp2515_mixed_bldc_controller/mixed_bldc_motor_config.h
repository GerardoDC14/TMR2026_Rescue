...
static constexpr MixedMotorConfig kMotorConfigs[] = {
    {"joint5", DRIVER_LKTECH, 14, 10.0, 10.0, 10.0, 360.0, true},
    {"joint6", DRIVER_LKTECH, 15, 10.0, 10.0, 10.0, 360.0, true},
    {"ze300", DRIVER_ZE300, 1, 8.0, 1.0, 1.0, 100.0, true},
};
